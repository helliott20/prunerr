...
export default interface Resources {
  "activityLog": {
    ...
    "formatter": {
      ...
      "deleted": "Deleted",
      "episodesQueued_one": "{{count}} episodes queued for deletion",
      "episodesQueued_other": "{{count}} episodes queued for deletion",
      "episodesUnqueued_one": "{{count}} episodes taken out of the queue",
  ...
  "library": {
    ...
    "episodeDeletion": {
      ...
      "graceHelpDelayed_one": "Episodes stay on disk for {{count}} days and can be taken back out of the queue at any point.",
      ...
      "selected_one": "{{count}} episodes selected",
      "selected_other": "{{count}} episodes selected",
      "titleNow_one": "Delete {{count}} episodes now",
      "titleNow_other": "Delete {{count}} episodes now",
      "titleQueue_one": "Queue {{count}} episodes for deletion",
      ...
      "toastCancelledMsg_one": "{{count}} episodes will be kept",
      "toastCancelledMsg_other": "{{count}} episodes will be kept",
      "toastDeleted": "Episodes deleted",
      "toastDeletedMsg_one": "Deleted {{count}} episodes, freeing {{size}}",
      ...
      "toastQueuedMsg_one": "Queued {{count}} episodes for deletion",
