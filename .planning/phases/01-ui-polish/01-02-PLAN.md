...
must_haves:
  ...
  key_links:
    ...
    - from: "client/src/components/Queue/Queue.tsx"
      to: "client/src/components/common/EmptyState.tsx"
      via: "import and use for empty queue"
      pattern: "EmptyState"
    - from: "client/src/components/History/History.tsx"
      to: "client/src/components/common/EmptyState.tsx"
      via: "import and use for empty history"
      pattern: "EmptyState"
    - from: "client/src/components/Rules/Rules.tsx"
      to: "client/src/components/common/EmptyState.tsx"
      via: "import and use for empty rules"
      pattern: "EmptyState"
    - from: "client/src/components/Recommendations/Recommendations.tsx"
      to: "client/src/components/common/EmptyState.tsx"
      via: "import and use for empty recommendations"
      pattern: "EmptyState"
---
